...
<section class="our-systems">
	<div class="container">
		<div class="row">
			...
			<div class="span12 align-center">
				<a href="#" class="info-arrows slider-left"><i class="icon-left"></i></a>
				<a href="#" class="info-arrows slider-right"><i class="icon-right"></i></a>				
			</div>			
		</div>		
	</div>
	...
	$(function(){
		...
		$(".info-arrows.slider-left").click(function(event) {
			event.preventDefault();
			mySwiper2.swipePrev();
		});

		$(".info-arrows.slider-right").click(function(event) {
			event.preventDefault();
			mySwiper2.swipeNext();
		});	
	});	
