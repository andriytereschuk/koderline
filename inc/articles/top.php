...
<section class="bg-top articles-top">
	<div class="container">
		<div class="row">
			<div class="span12">
				<div class="top-section">
					<div class="up-section">
						<i class="icon-pencil-big"></i>
					</div>
					<h1>Статьи экспертов</h1>	
				</div>				
			</div>
		</div>
		...
		<div class="row pt-20">
			<div class="span12">
				<ul class="ar-cat">
					<li class="ar-act"><span>Категория</span></li>
					<li><span>Категория</span></li>
					<li><span>Категория</span></li>
					<li><span>Категория</span></li>
					<li><span>Комплексная автоматизация</span></li>
				</ul>
			</div>
		</div>
